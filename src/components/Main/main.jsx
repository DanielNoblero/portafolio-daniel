    ...
    <main className='main-container'>
      ...
      <div className="projects-grid">
        <div className="project-card">
          <img src="public/assets/imagenes/python.png" alt="Proyecto 1" />
          <h3>Python</h3>
      ...
      <div className="project-card">
        <img src="public/assets/imagenes/Html.png" alt="Proyecto 2" />
      ...
      <div className="project-card">
        <img src="public/assets/imagenes/react.png" alt="Proyecto 3" />
        <h3>React.js</h3>
